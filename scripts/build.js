...
const THEME_YAML_FILE = path.join(__dirname, '..', 'src', 'monokai-dark-green.yml');
...
async function build() {
  ...
  const standardThemePath = path.join(THEME_DIR, 'monokai-dark-green.json');
  const softThemePath = path.join(THEME_DIR, 'monokai-dark-green-soft.json');
